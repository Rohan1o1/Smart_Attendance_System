...
import { z } from 'zod';
import { Eye, EyeOff, Mail, Lock, AlertCircle, Loader, ArrowLeft, BookOpen } from 'lucide-react';
...
const TeacherLogin = () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (user.role !== 'teacher') {
          setApiError('This login is for teachers only. Please use the appropriate login page.');
          return;
        }
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left side - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-500 to-green-700 items-center justify-center">
