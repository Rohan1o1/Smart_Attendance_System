 ...
 * Department Head login using Email + Password
 */
...
import { z } from 'zod';
import { Eye, EyeOff, Mail, Lock, AlertCircle, Loader, ArrowLeft, Building } from 'lucide-react';
...
const AdminLogin = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (result.success) {
        ...
        // Check if admin
        if (user.role !== 'admin') {
          setApiError('This login is for department admins only. Please use the appropriate login page.');
          return;
        }
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left side - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-500 to-purple-700 items-center justify-center">
        <div className="text-center text-white p-8">
          ...
          <div className="text-sm opacity-75 space-y-2">
            <p>✓ Verify teachers & students</p>
            <p>✓ Manage department users</p>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
